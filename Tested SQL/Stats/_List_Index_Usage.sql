USE [DBA]
GO
/****** Object:  StoredProcedure [dbo].[sp_viewIndexUsage]    Script Date: 11/07/2023 14:13:06 ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
ALTER PROCEDURE [dbo].[sp_viewIndexUsage] 
	@StartDatePart varchar(20)='2023-11-07',
	@DB varchar(100) = 'All'
AS
BEGIN

	SET NOCOUNT ON;
	Declare @StartSTR nvarchar(100), @FinishSTR nvarchar(100) 
